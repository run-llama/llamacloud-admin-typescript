...
import { LlamaCloudAdminError } from './error';
...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: LlamaCloudAdmin, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
  ...
  async getNextPage(): Promise<this> {
    ...
    if (!nextOptions) {
      throw new LlamaCloudAdminError(
