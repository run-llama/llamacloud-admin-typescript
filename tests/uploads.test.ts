import fs from 'fs';
import type { ResponseLike } from '@llamaindex/llama-cloud-admin/internal/to-file';
import { toFile } from '@llamaindex/llama-cloud-admin/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@llamaindex/llama-cloud-admin/core/uploads');
    await expect(
